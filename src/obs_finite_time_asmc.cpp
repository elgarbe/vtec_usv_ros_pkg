...
public:
  ...
  AdaptiveSlidingModeControl()
  {
    ...
    n.param("/obs_finite_time_asmc/L1_u", L1_u);
    n.param("/obs_finite_time_asmc/L1_dot_u", L1_dot_u);
    n.param("/obs_finite_time_asmc/L1_r", L1_r);
    n.param("/obs_finite_time_asmc/L1_dot_r", L1_dot_r);
    n.param("/obs_finite_time_asmc/epsilon", epsilon);
    n.param("/obs_finite_time_asmc/ro", ro);
    n.param("/obs_finite_time_asmc/K2_u", K2_u);
    n.param("/obs_finite_time_asmc/K2_r", K2_r);
    n.param("/obs_finite_time_asmc/mu_u", mu_u);
    n.param("/obs_finite_time_asmc/mu_r", mu_r);
    n.param("/obs_finite_time_asmc/lambda_u", lambda_u);
    n.param("/obs_finite_time_asmc/lambda_r", lambda_r);
    n.param("/obs_finite_time_asmc/k_u", k_u);
    n.param("/obs_finite_time_asmc/k_r", k_r);
    n.param("/obs_finite_time_asmc/Kmin_u", Kmin_u);
    n.param("/obs_finite_time_asmc/Kmin_r", Kmin_r);
    n.param("/obs_finite_time_asmc/t_c", t_c);
