...
public:
  ...
  AdaptiveSlidingModeControl()
  {
    ...
    n.param("/tracking_control_sast3/ka_x", ka_x, dka_x);
    n.param("/tracking_control_sast3/ka_y", ka_y, dka_y);
    n.param("/tracking_control_sast3/mu_x", mu_x, dmu_x);
    n.param("/tracking_control_sast3/mu_y", mu_y, dmu_y);
    n.param("/tracking_control_sast3/lambda_x", lambda_x, dlambda_x);
    n.param("/tracking_control_sast3/lambda_y", lambda_y, dlambda_y);
...
{
  ros::init(argc, argv, "tracking_control_sast3");
