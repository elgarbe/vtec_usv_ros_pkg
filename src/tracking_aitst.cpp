...
public:
  ...
  AdaptiveSlidingModeControl()
  {
    ...
    x_gain_pub = n.advertise<std_msgs::Float64>("/usv_control/aitst/x_gain", 1000);
    x_error_pub = n.advertise<std_msgs::Float64>("/usv_control/controller/x_error", 1000);
    x_sigma_pub = n.advertise<std_msgs::Float64>("/usv_control/aitst/x_sigma", 1000);
    y_sigma_pub = n.advertise<std_msgs::Float64>("/usv_control/aitst/y_sigma", 1000);
    y_gain_pub = n.advertise<std_msgs::Float64>("/usv_control/aitst/y_gain", 1000);
    ...
    static constexpr float dk_x = 0.02;
    static constexpr float dk_y = 0.02;
    static constexpr float dkmin_x = 0.001;
    static constexpr float dkmin_y = 0.001;
    static constexpr float depsilon_x = 0.01;
    static constexpr float depsilon_y = 0.01;
    static constexpr float dmu_x = 0.1;
    static constexpr float dmu_y = 0.1;
    static constexpr float dtc_x = 10;
    static constexpr float dtc_y = 10;
    static constexpr float dq_x = 3;
    static constexpr float dq_y = 3;
    static constexpr float dp_x = 5;
    static constexpr float dp_y = 5;
    ...
    static constexpr float depsilon_r = 0.01;
    static constexpr float dmu_u = 0.1;
    static constexpr float dmu_r = 0.1;
    static constexpr float dtc_u = 3;
    static constexpr float dtc_r = 3;
    static constexpr float dq_u = 3;
    static constexpr float dq_r = 3;
    static constexpr float dp_u = 5;
    static constexpr float dp_r = 5;

    n.param("/tracking_aitst/k_x", k_x, dk_x);
    n.param("/tracking_aitst/k_y", k_y, dk_y);
    n.param("/tracking_aitst/kmin_x", kmin_x, dkmin_x);
    n.param("/tracking_aitst/kmin_y", kmin_y, dkmin_y);
    n.param("/tracking_aitst/epsilon_x", epsilon_x, depsilon_x);
    n.param("/tracking_aitst/epsilon_y", epsilon_y, depsilon_y);
    n.param("/tracking_aitst/mu_x", mu_x, dmu_x);
    n.param("/tracking_aitst/mu_y", mu_y, dmu_y);
    n.param("/tracking_aitst/tc_x", tc_x, dtc_x);
    n.param("/tracking_aitst/tc_y", tc_y, dtc_y);
    n.param("/tracking_aitst/q_x", q_x, dq_x);
    n.param("/tracking_aitst/q_y", q_y, dq_y);
    n.param("/tracking_aitst/p_x", p_x, dp_x);
    n.param("/tracking_aitst/p_y", p_y, dp_y);
    n.param("/tracking_aitst/k_u", k_u, dk_u);
    n.param("/tracking_aitst/k_r", k_r, dk_r);
    n.param("/tracking_aitst/kmin_u", kmin_u, dkmin_u);
    n.param("/tracking_aitst/kmin_r", kmin_r, dkmin_r);
    n.param("/tracking_aitst/epsilon_u", epsilon_u, depsilon_u);
    n.param("/tracking_aitst/epsilon_r", epsilon_r, depsilon_r);
    n.param("/tracking_aitst/mu_u", mu_u, dmu_u);
    n.param("/tracking_aitst/mu_r", mu_r, dmu_r);
    n.param("/tracking_aitst/tc_u", tc_u, dtc_u);
    n.param("/tracking_aitst/tc_r", tc_r, dtc_r);
    n.param("/tracking_aitst/q_u", q_u, dq_u);
    n.param("/tracking_aitst/q_r", q_r, dq_r);
    n.param("/tracking_aitst/p_u", p_u, dp_u);
    n.param("/tracking_aitst/p_r", p_r, dp_r);
...
{
  ros::init(argc, argv, "tracking_aitst");
