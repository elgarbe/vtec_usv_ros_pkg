...
public:
  ...
  AdaptiveSlidingModeControl()
  {
    ...
    static constexpr float depsilon_x = 0.05;
    static constexpr float depsilon_y = 0.05;
    ...
    n.param("/tracking_control_ast/k_x", k_x, dk_x);
    n.param("/tracking_control_ast/k_y", k_y, dk_y);
    n.param("/tracking_control_ast/kmin_x", kmin_x, dkmin_x);
    n.param("/tracking_control_ast/kmin_y", kmin_y, dkmin_y);
    n.param("/tracking_control_ast/epsilon_x", epsilon_x, depsilon_x);
    n.param("/tracking_control_ast/epsilon_y", epsilon_y, depsilon_y);
    n.param("/tracking_control_ast/mu_x", mu_x, dmu_x);
    n.param("/tracking_control_ast/mu_y", mu_y, dmu_y);
    n.param("/tracking_control_ast/lambda_x", lambda_x, dlambda_x);
    n.param("/tracking_control_ast/lambda_y", lambda_y, dlambda_y);
...
{
  ros::init(argc, argv, "tracking_control_ast");
